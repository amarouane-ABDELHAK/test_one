...
├── test_one             # The main python package for the project
...
Just click on [Use this template](https://github.com/amarouane-ABDELHAK/project-template/generate) and you are good to go.
...
e.g: `cat test_one/VERSION` will get the project version without harming
